...
{
	if(thePerson->GetHivDeath() && theTime >= 16801.5 && theTime < 31411.5) {
		// NeverDiagnosed
...
{
	if(thePerson->GetEverCd4TestState() && thePerson->GetHivDeath() && theTime >= 16801.5 && theTime < 31411.5) {
		// NeverDiagnosed
